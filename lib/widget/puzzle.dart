import 'package:crypto_puz/providers/puzzle_game.dart';
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: controller.tiles[i].tileIsWhiteSpace
                            ? Colors.transparent
                            : Theme.of(context).colorScheme.secondary,
                        // image: !indexTile.tileIsWhiteSpace ? DecorationImage( image: AssetImage("assets/boards/4x4/${indexTile.value}.jpg"), fit: BoxFit.cover): null
                      ),
                      child: Text(
